    ...
    <div className="hod-main-container">
       ...
       <Header/>
            ...
            <div className='top-container'>
                ...
                <br/>
                <p className='designtion'>Proff</p>
</div>
            </div>
            </div>
            {/* <button className='apply-btn' onClick={renderForm}>Apply Leave</button> */}
            <ApplyHeader/>
            ...
            <div className='count-containers'>
                ...
                <p className='card-description'>Available Earn Leaves</p>
                <p className='count-txt'>5</p>
                </div>

                <div className='count-container-2'>
                <p className='card-description'>Available Medical Leaves</p>
                <p className='count-txt-2'>4</p>
                </div>

                <div className='count-container-3'>
                <p className='card-description'>Available Casual Leaves</p>
                <p className='count-txt-3'>3</p>
                </div>

                <div className='count-container-4'>
                <p className='card-description'>
                Available Meternity Leaves</p>
